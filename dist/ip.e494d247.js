...
var myFunc = function myFunc(nesne) {
  ...
  h3Element.textContent = "Ip adresi: ".concat(cevap.sorgu);
  infoDiv.append(h3Element);
  var ulkeP = document.createElement("p");
  ulkeP.setAttribute("class", "ulke");
  ulkeP.textContent = "\xDClke ad\u0131: ".concat(cevap.ülke, ", \xDClke Kodu: (").concat(cevap.ülkeKodu, ")");
  infoDiv.append(ulkeP);
  var enlemP = document.createElement("p");
  enlemP.textContent = "Enlem: ".concat(cevap.enlem, " Boylam: ").concat(cevap.boylam);
  infoDiv.append(enlemP);
  var sehirP = document.createElement("p");
  sehirP.textContent = "\u015Eehir: ".concat(cevap.şehir);
  infoDiv.append(sehirP);
  var saatP = document.createElement("p");
  saatP.textContent = "Saat Dilimi: ".concat(cevap.saatdilimi);
  infoDiv.append(saatP);
  var paraP = document.createElement("p");
  paraP.textContent = "Para birimi: ".concat(cevap.parabirimi);
  infoDiv.append(paraP);
  var ispP = document.createElement("p");
  ispP.textContent = "ISP: ".concat(cevap.isp);
  infoDiv.append(ispP);
  return cardDiv;
};
/*
